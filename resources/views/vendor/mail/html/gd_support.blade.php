            ...
            <table data-module="module-2" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td data-bgcolor="bg-module" bgcolor="#eaeced">
                        <table class="flexible" style="margin:0 auto;" width="600" cellspacing="0" cellpadding="0"
                               align="center">
                            <tbody>
                            <tr>
                                <td style="vertical-align:top; width:600px; height:200px; color: #fefefe;
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                        <tr>
                                            <td style="height: 20px; line-height: 10px; font-size: 10px; width: 100%; padding-top: 20px;"
                                                align="center">
                                                <img src="{{ asset('img/gd_logo.png') }}" width="60px" height="60px">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="height: 20px; line-height: 20px; width: 100%;padding-top: 60px; color: #F1FDFF;"
                                                align="center">
                            ...
                            <tr>
                                <td data-bgcolor="bg-block" class="holder"
                                    style="padding:58px 60px 12px; color: #626365;" bgcolor="#E6E7E9">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        <tbody>
                                        <tr class="">
                                            <td>
                                                <h3 class="content-text">Greetings, </h3><br>
                                        ...
                                        <tr>
                                            <td>
                                                <p class="content-text"
                                                   style="margin:0;padding-top:10px;font-size: 10px">
                                                    <br>
                                                    P.S Please send your response to
                                                    <span
                                                        style="font-weight: bold; font-size: 10px">{{$sender_email}}</span>
                                                </p>
                            ...
                            <tr>
                                <td style="vertical-align:bottom; width:600px; height:50px; color: #fefefe; background-color: #255B1C; padding: 15px 0;">
                                    <table width="80%" cellspacing="0" cellpadding="0" align="center">
                                        <tbody>
                                        <tr>
                                            <td style="font-size: 8px; line-height: 22px;" valign="middle"
                                                align="center">
                                       <span style="font-size: 10px; color: #CDD9E8;">
                                          <a href="#" target="_blank"
                                             style="color: #CDD9E8; font-size: 10px; text-decoration: none; margin-right: 0.5%;">Home</a> |
                                          <a href="#" target="_blank"
                                             style="color: #CDD9E8; font-size: 10px; text-decoration: none; margin-right: 0.5%; margin-left: 0.5%;">Support</a> |
                                          <a href="#" target="_blank"
                                             style="color: #CDD9E8; font-size: 10px; text-decoration: none; margin-left: 0.5%;">Contact</a>
                                      </span>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <a target="_blank" href="https://twitter.com/"
                                                   style="text-decoration: none;">
                                                    <img src="{{ asset('img/twitter.png') }}"
                                                         style="width: 16px; height: 16px; margin-right: 1%;">
                                                </a>
                                                ...
                                                <a target="_blank" href="https://www.medium.com/"
                                                   style="text-decoration: none;">
                                                    <img src="{{ asset('img/medium.png') }}"
                                                         style="width: 18px; height: 18px; margin-right: 1%;">
                                                </a>
                                                <a target="_blank" href="tel:+09090000000"
                                                   style="text-decoration: none;">
                            ...
                            <tr>
                                <td class="footer" style="padding:0 0 20px;">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        <tbody>
                                        <tr class="table-holder">
                                            <th class="tfoot" style="vertical-align:top; padding:7px 0 0 0;" width="400"
                                                align="center">
                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                    <tr>
                                                        <td data-color="text" data-link-color="link text color"
                                                            ...
                                                            class="aligncenter"
                                                            style="font:12px/16px Avenir, Geneva, sans-serif; color:#797c82; padding:0 0 10px;"
                                                            align="center">
                                                            © {{ date('Y') }} Goto
                                                            Dispatch. @lang('All rights reserved.')
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
